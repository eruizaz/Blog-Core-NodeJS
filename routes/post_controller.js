               ...
               .success(function(attachments) {
                  ...
                  models.Comment
                       ...
                       .success(function(comments) {
                          ...
                          //miramos si el usuario tiene puntuación para el post
                          if(req.session.user) {
                            favs.forEach(function(miFavorito) {
                              if(miFavorito.userId == req.session.user.id) {
                                req.post.best = miFavorito.best;
                              }
                            })
                          }
